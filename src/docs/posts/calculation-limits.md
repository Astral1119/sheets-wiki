...
# Recursion Calls
The recursion limit is exactly `10,000` (`1e4`). This limit is the same when used in [LAMBDA recursion](sheets.wiki/lambda-recursion) and [iterative calculation](sheets.wiki/iterative-calculation).
# Further Reading
