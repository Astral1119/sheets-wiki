...
# Recursion Calls
The recursion limit is exactly `10,000` (`1e4`). This limit is the same when used in [[Lambda Recursion]] and [iterative calculation](https://sheets.wiki/iterative-calculation).
# Further Reading
